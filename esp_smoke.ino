...
const char* sensorLOW = "No Smoke Detected";
const char* sensorHIGH = "Smoke Detected!";
const char* sensorWARN = "Smoke Recently Detected!";
...
// esp settings
const char* espHostname = "esp-has-smoke";
const char* espClientId = "smokeClient";


// topics to subscribe and publish to
const char* topic = "smoke";
const char* topicAck = "smoke/acknowledge";
const char* topicTest = "smoke/test";
const char* topicStatus = "smoke/status";
