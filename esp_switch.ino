...
const char* sensorLOW = "Switch Is Closed!";
const char* sensorHIGH = "Switch Is Open!";
const char* sensorWARN = "Switch Recently Opened!";
...
// esp settings
const char* espHostname = "esp-has-switch";
const char* espClientId = "switchClient";


// topics to subscribe and publish to
const char* topic = "switch";
const char* topicAck = "switch/acknowledge";
const char* topicTest = "switch/test";
const char* topicStatus = "switch/status";
